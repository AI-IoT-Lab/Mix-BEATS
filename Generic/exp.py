...
from models import MixBEATS, NBEATS, Informer, Autoformer, iTransformer, Reformer, DLinear, PatchTST, TimesNet, FEDformer
...
def exp(args, model, criterion, optimizer, device, train_loader, val_loader, test_loader):
    ...
    print(f'{id},{seq_len},{patch_size},{num_blocks_per_stack},{thetas_dim},{hidden_dim},{mse:.3f}')
...
if __name__ == '__main__':
    ...
    for seq_len in [96,192,336]:
        for patch_size in [6,12,24,48]:
            for num_block in [2,3,6]:
                for thetas_dim in [2,4,8]:
                    for hidden_dim in [64,128,256,512]:

                        args['seq_len'] = seq_len
                        args['patch_size'] = patch_size 
                        args['num_blocks_per_stack'] = num_block
                        args['thetas_dim'] = thetas_dim 
                        ...
                        exp(args, model, criterion, optimizer, device, train_loader, val_loader, test_loader)
